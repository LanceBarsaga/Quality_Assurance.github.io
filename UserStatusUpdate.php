...
if(isset($_POST['updatestatus'])){
    ...
    if($result_update = mysqli_query($conn, $sql_update)){
        ?>
        <script>
            alert('Successfully marked as Pending \nPlease wait for the QA to respond');
            window.location.href='OCCSDashboard.php';
        </script>
        <?php
    } else {
  ...
  if(isset($_POST['BackToUsersDashboard'])){
    ?>
    <script>
        window.location.href='OCCSDashboard.php';
    </script>
